...
dgemm_simple: prepare
	gcc -O3 -o out/dgemm_simple dgemm_simple.c debug.c
	./exec.sh ./out/dgemm_simple

.PHONY: dgemm_transpose
dgemm_transpose: prepare
	gcc -O3 -o out/dgemm_transpose dgemm_transpose.c debug.c
	./exec.sh ./out/dgemm_transpose

.PHONY: dgemm_avx256
dgemm_avx256: prepare
	gcc -O3 -mavx2 -o out/dgemm_avx256 dgemm_avx256.c debug.c
	./exec.sh ./out/dgemm_avx256

.PHONY: dgemm_avx256_unroll_2
dgemm_avx256_unroll_2: prepare
	gcc -O3 -mavx2 -DUNROLL=2 -o out/dgemm_avx256_unroll_2 dgemm_avx256_unroll.c debug.c
	./exec.sh ./out/dgemm_avx256_unroll_2

.PHONY: dgemm_avx256_unroll_4
dgemm_avx256_unroll_4: prepare
	gcc -O3 -mavx2 -DUNROLL=4 -o out/dgemm_avx256_unroll_4 dgemm_avx256_unroll.c debug.c
	./exec.sh ./out/dgemm_avx256_unroll_4

.PHONY: dgemm_avx256_unroll_8
dgemm_avx256_unroll_8: prepare
	gcc -O3 -mavx2 -DUNROLL=8 -o out/dgemm_avx256_unroll_8 dgemm_avx256_unroll.c debug.c
	./exec.sh ./out/dgemm_avx256_unroll_8

.PHONY: dgemm_avx256_unroll_16
dgemm_avx256_unroll_16: prepare
	gcc -O3 -mavx2 -DUNROLL=16 -o out/dgemm_avx256_unroll_16 dgemm_avx256_unroll.c debug.c
	./exec.sh ./out/dgemm_avx256_unroll_16

.PHONY: dgemm_avx256_unroll_32
dgemm_avx256_unroll_32: prepare
	gcc -O3 -mavx2 -DUNROLL=32 -o out/dgemm_avx256_unroll_32 dgemm_avx256_unroll.c debug.c
...
dgemm_transpose_unroll_2: prepare
	gcc -O3 -mavx2 -DUNROLL=2 -o out/dgemm_transpose_unroll_2 dgemm_transpose_unroll.c debug.c
	./exec.sh ./out/dgemm_transpose_unroll_2

.PHONY: dgemm_transpose_unroll_4
dgemm_transpose_unroll_4: prepare
	gcc -O3 -mavx2 -DUNROLL=4 -o out/dgemm_transpose_unroll_4 dgemm_transpose_unroll.c debug.c
	./exec.sh ./out/dgemm_transpose_unroll_4

.PHONY: dgemm_transpose_unroll_8
dgemm_transpose_unroll_8: prepare
	gcc -O3 -mavx2 -DUNROLL=8 -o out/dgemm_transpose_unroll_8 dgemm_transpose_unroll.c debug.c
	./exec.sh ./out/dgemm_transpose_unroll_8

.PHONY: dgemm_transpose_unroll_16
dgemm_transpose_unroll_16: prepare
	gcc -O3 -mavx2 -DUNROLL=16 -o out/dgemm_transpose_unroll_16 dgemm_transpose_unroll.c debug.c
	./exec.sh ./out/dgemm_transpose_unroll_16

.PHONY: dgemm_transpose_unroll_32
dgemm_transpose_unroll_32: prepare
	gcc -O3 -mavx2 -DUNROLL=32 -o out/dgemm_transpose_unroll_32 dgemm_transpose_unroll.c debug.c
...
dgemm_avx512: prepare
	gcc -O3 -mavx512f -o out/dgemm_avx512 dgemm_avx512.c debug.c
